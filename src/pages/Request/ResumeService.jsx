        ...
        <div className="bg-grayHome h-full">
                ...
                <Link to={'/home'}>
                    <IoIosArrowBack className="text-white w-6 h-6"/>
                     ...
                     <span className="text-white text-xl font-md ml-8">Resumen Servicio</span>
                    <Link href="">
                ...
                <span className="text-black font-bold text-xl ml-8 justify-center w-full">Detalles Generales</span>
                {/* Form */}
                ...
                <form className="max-w-md mx-auto">
                    ...
                    <div className="flex border-b-2 border-b-solid border-gray-300 mb-3  pb-3 items-center">
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="w-4/5">Departamento . Piso 2 B Lima 12345 . Cordoba</span>
                        </div>
                    </div>
                    ...
                    <div className="flex border-b-2 border-b-solid border-gray-300 mb-3 p-2 pb-3 items-center">
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="w-4/5">Paola Torres . 35 años Cordoba capital</span>
                        </div>
                    </div>
                    ...
                    <div className="flex mb-3 p-2 pb-3 items-center">
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="w-full">!Hola! Necesito una limpieza general de mi depto y ademas, limpieza de vidrios y ventanas.</span>
                        </div>
                    </div>    
                 ...
                 <span className="text-black font-bold text-xl ml-8 justify-center w-full">Resumen de pago</span>
                 <div className='shadow-xl bg-white h-min-height w-min-widht mt-6 rounded-xl mx-4 p-6' style={{ marginBottom: '1rem' }}>
                <form className="max-w-md mx-auto">
                    {/* Total de pago */}
