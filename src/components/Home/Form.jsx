    ...
    return(
        ...
        <div className='bg-white h-min-h w-min-w mt-8 rounded-xl mx-6 p-8 relative z-10'>
                    ...
                    <div className='flex justify-between w-full mt-4 gap-4'>
                        ...
                        <Link className={`flex justify-center items-center flex-col container mx-auto border-solid border-2 border-black rounded-lg w-24 h-28 ${
                        ...
                        <Link href='#' className={`flex justify-center items-center flex-col container mx-auto border-solid border-2 border-black rounded-lg w-24 h-28 ${
